import { Box, Drawer, List, ListItem, ListItemButton, ListItemText, Typography, IconButton, Divider, Tooltip } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import LogoutIcon from '@mui/icons-material/Logout';

const ChatHistory = ({ open, onClose, history, onSelectChat, onLogout }) => {
  return (
    <Drawer
      anchor="left"
      open={open}
